# test_win2k_ss_threaded.py
# Test the threaded stack_type option of the callstack_instr plugin.
#
# Created:  06-JUN-2019
...
OUTPUT_PREFIX = "win2k_ss_threaded"
...
REPLAY_SS = ptest.Replay(REPLAY_PATH, QEMU, STRINGSEARCH, CALLSTACK,
    os="windows-32-2000")
