# test_winxp_ss_heur.py
# Test the heuristic stack_type option of the callstack_instr plugin.
#
# Created:  06-JUN-2019
...
OUTPUT_PREFIX = "winxp_ss_heur"

STRINGSEARCH = ptest.Plugin("stringsearch", str="value", callers=128)
CALLSTACK = ptest.Plugin("callstack_instr", stack_type="heuristic")
...
def run():
    ...
    # run the test with heuristic stack_type specified
