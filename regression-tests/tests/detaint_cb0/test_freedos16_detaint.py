# test_freedos16_detaint.py
# Test taint2's detaint_cb0 option on a recording made of a 16-bit binary
# running under FreeDOS.
#
# Created:  08-OCT-2018
# Changed:  27-FEB-2019   Verify all taint results, now that the issue with
...
def run():
    ...
    retcode = dtcommon.DoComparison("freedos16", QEMU, REPLAY_PATH, "pc = 0x")
    if (not retcode):
        return False
