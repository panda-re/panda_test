...
REPLAY_PATH = os.path.join("debian64", "linux64_pread")
...
TAINTED_PC1 = 0x561AB9936989

# block where compare with 0x2345
TAINTED_PC2 = 0x561AB99369B9

# block where compare with 0x3456
TAINTED_PC3 = 0x561AB99369DD
