# test_debian64_singleproc_singlefile.py
# Test the file_taint plugin using a 64-bit guest and a binary reading a single
# file in a single process.
#
# Created:  25-OCT-2019
...
REPLAY_PATH = os.path.join("debian64", "linux64_sp_sf")
