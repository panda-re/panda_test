...
def run():
    ...
    try:
        with ptest.PlogReader(PLOG1) as plr:
            for i, m in enumerate(plr):
                ...
                if m.pc == 0x080486E0 and m.HasField("tainted_branch"):
                    found_branch = True
                if m.pc == 0x0804870C and m.HasField("tainted_branch"):
                    print("0x0804870C should not have been reported")
                    return False
                if m.pc == 0x08048738 and m.HasField("tainted_branch"):
                    print("0x08048738 should not have been reported")
                    return False
    except:
        print("error")
    if not found_branch:
        print("expected branch at 0x080486E0 not found")
        return False
    ...
    try:
        with ptest.PlogReader(PLOG2) as plr:
            for i, m in enumerate(plr):
                ...
                if m.pc == 0x0804870C and m.HasField("tainted_branch"):
                    found_branch = True
                if m.pc == 0x080486E0 and m.HasField("tainted_branch"):
                    print("0x080486E0 should not have been reported")
                    return False
                if m.pc == 0x08048738 and m.HasField("tainted_branch"):
                    print("0x08048738 should not have been reported")
                    return False
        ...
        pass
    if not found_branch:
        print("expected branch at 0x0804870C not found")
        return False
    ...
    try:
        ...
        pass
    if not found_branch:
        print("expected branch at 0x08048726 not found")
        return False
