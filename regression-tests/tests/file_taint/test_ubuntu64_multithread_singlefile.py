# test_ubuntu64_multithread_singlefile.py
# Test the file_taint plugin option using a 64-bit guest and a binary that opens
# the same file in three different threads.
#
# Created:  25-OCT-2019
...
REPLAY_PATH = os.path.join("ubuntuserver64", "linux64_mt_sf")
...
def run():
    ...
    found_branches = { 0x4009F5: False, 0x400AD9: False, 0x400BBD: False }
    try:
