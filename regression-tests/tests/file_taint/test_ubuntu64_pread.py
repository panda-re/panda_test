# test_ubuntu64_pread.py
# Test the file_taint plugin start and end position options using a 64-bit
# guest and a binary that uses the pread system call.
#
# Created:  25-OCT-2019
...
REPLAY_PATH = os.path.join("ubuntuserver64", "linux64_pread")
...
TAINTED_PC1 = 0x40087E

# block where compare with 0x2345
TAINTED_PC2 = 0x4008AA

# block where compare with 0x3456
TAINTED_PC3 = 0x4008CA

def run():
    print(INDENT_SPACES + "This test takes about 20 minutes to run.  Started at:  " +
