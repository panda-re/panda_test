...
REPLAY2 = ptest.Replay("2k-filetaint-positional", QEMU,
    FILE_TAINT_INPUT2, TAINTED_BRANCH, os="windows-32-2000", plog=PLOG2)
_, PLOG3 = tempfile.mkstemp()
REPLAY3 = ptest.Replay("2k-filetaint-positional", QEMU,
    FILE_TAINT_INPUT3, TAINTED_BRANCH, os="windows-32-2000", plog=PLOG3)
