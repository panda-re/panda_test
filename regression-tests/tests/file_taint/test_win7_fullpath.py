...
FILE_TAINT_INPUT1 = ptest.Plugin("file_taint", filename="\\Users\\panda\\Desktop\\file_taint_test\\input1.bin")
...
REPLAY1 = ptest.Replay("7-filetaint-singleproc-singlefile", QEMU,
    FILE_TAINT_INPUT1, TAINTED_BRANCH, os="windows-32-7", plog=PLOG1)
_, PLOG2 = tempfile.mkstemp()
REPLAY2 = ptest.Replay("7-filetaint-singleproc-singlefile", QEMU,
