...
REPLAY1 = ptest.Replay("7-filetaint-singleproc-multifile", QEMU,
    FILE_TAINT_INPUT1, TAINTED_BRANCH, os="windows-32-7", plog=PLOG1)
_, PLOG2 = tempfile.mkstemp()
REPLAY2 = ptest.Replay("7-filetaint-singleproc-multifile", QEMU,
    FILE_TAINT_INPUT2, TAINTED_BRANCH, os="windows-32-7", plog=PLOG2)
_, PLOG3 = tempfile.mkstemp()
REPLAY3 = ptest.Replay("7-filetaint-singleproc-multifile", QEMU,
