# test_ubuntu_defcounter.py
# Test the replaymovie plugin using a guest without a GUI, with an instruction
# counter at the default location in the movie.
#
# Created:  22-AUG-2019
...
FILE_PREFIX = "ubuntu32_defcounter"
...
# the default counter location is the lower right corner of the movie
MOVIE = ptest.Plugin("replaymovie", save_instruction_count=True)
...
def run():
    ...
    expected_movie = os.path.join(TEST_DIR_PREFIX,
        "ubuntu32_defcounter_expected.mp4")
