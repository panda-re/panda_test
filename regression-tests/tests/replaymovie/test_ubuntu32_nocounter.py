# test_ubuntu_nocounter.py
# Test the replaymovie plugin using a guest without a GUI, and not requesting an
# instruction counter.
#
# Created:  22-AUG-2019
...
FILE_PREFIX = "ubuntu32_nocounter"
...
# the default is to not produce a file with instruction counter information,
# which is what we want
MOVIE = ptest.Plugin("replaymovie")
...
def run():
    ...
    expected_movie = os.path.join(TEST_DIR_PREFIX,
        "ubuntu32_nocounter_expected.mp4")
