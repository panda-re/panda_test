...
def run():
    ...
    # Note block 0x401ea0 has taint in it from more instructions than SHL 0.
    ...
    retcode = shlcommon.DoComparison("freedos32", QEMU, REPLAY_PATH, "0x401ea0",
        17)
    if (not retcode):
        return False
