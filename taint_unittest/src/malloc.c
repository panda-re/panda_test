...
// malloc and label each byte in buffer
/**
char *buf;
buf = (void *)malloc(8);
...
int main(int argc, char **argv) {
    ...
    panda_taint_assert_label_range(&buf[0], sizeof(char), b0_LABEL);
    panda_taint_assert_label_range(&buf[1], sizeof(char), b1_LABEL);
    panda_taint_assert_label_range(&buf[2], sizeof(char), b2_LABEL);
    panda_taint_assert_label_range(&buf[3], sizeof(char), b3_LABEL);
    panda_taint_assert_label_range(&buf[4], sizeof(char), b4_LABEL);
    panda_taint_assert_label_range(&buf[5], sizeof(char), b5_LABEL);
    panda_taint_assert_label_range(&buf[6], sizeof(char), b6_LABEL);
    panda_taint_assert_label_range(&buf[7], sizeof(char), b7_LABEL);
